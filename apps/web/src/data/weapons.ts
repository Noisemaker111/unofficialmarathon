...
const weaponSeed: Weapon[] = [
  ...
  { id: "biotoxic-disinjector", name: "Biotoxic Disinjector", category: "assault_rifle", description: "Unique assault rifle that deploys biotoxic payloads against hostiles.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Light Rounds", unique: true, special: "Unique variant", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  { id: "m77-omnipositor", name: "M77 Omnipositor", category: "assault_rifle", description: "Unique M77 variant with modular omnipositor attachment system.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Light Rounds", unique: true, special: "Unique variant", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  // Machine Guns
  ...
  { id: "salt-wages", name: "Salt Wages", category: "machine_gun", description: "Unique heavy machine gun with punishing sustained fire.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Heavy Rounds", unique: true, special: "Unique variant", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  // Precision Rifles
  ...
  { id: "v95-lookout", name: "V95 Lookout", category: "precision_rifle", description: "High-tier volt precision rifle with extended tracking range.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Volt Battery", unique: true, special: "Unique variant", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  // Pistols
  ...
  { id: "d54-battle-pistol", name: "D54 Battle Pistol", category: "pistol", description: "Heavy sidearm built for close-quarters engagements.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Heavy Rounds", unique: true, special: "Unique variant", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  // Railguns
  ...
  { id: "v85-free-tail", name: "V85 Free-Tail", category: "railgun", description: "Unique volt railgun with unstable tail discharge.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Volt Cells", unique: true, special: "Unique variant", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  { id: "v99-watchtower", name: "V99 Watchtower", category: "railgun", description: "Long-range volt rail platform for area denial.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Volt Cells", unique: true, special: "Unique variant", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  // Shotguns
  ...
  { id: "drrvish", name: "DRRVISH", category: "smg", description: "Special SMG found in Cryo Archive with unique volt behavior.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Volt Battery", unique: true, zone: "Cryo Archive", special: "Cryo Archive exclusive", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  { id: "kkv-9sd", name: "KKV-9SD", category: "smg", description: "Suppressed submachine gun optimized for covert runs.", firepower: "—", accuracy: "—", handling: "—", range: "—", magazine: "—", zoom: "—", ammoType: "Light Rounds", unique: true, special: "Unique variant", imageUrl: "", wikiUrl: "https://marathonthegame.fandom.com/wiki/Weapons" },
  // Melee
